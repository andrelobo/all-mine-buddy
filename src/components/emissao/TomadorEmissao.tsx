      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center gap-1.5 text-sm py-1.5 px-3 rounded-md border border-[hsl(144,72%,28%)] text-[hsl(144,72%,28%)] hover:bg-[hsl(144,72%,28%)]/10 transition-colors font-medium animate-pulse"
          >
